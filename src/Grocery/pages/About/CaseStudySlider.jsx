        ...
        <div className="row" style={{ padding: "20px" }}>
          ...
          <div className="col-md-6" style={{ padding: "20px" }}>
            <Swiper
              ...
              className="mySwiper"
            >
              {[member1, member2, member3].map((img, index) => {
                const testimonials = [
                  {
                    text: `"We are delighted by our association with TheJointApps! They have been really professional and extremely committed to the most complicated tasks. We wish them all the very best!"`,
                    author: "Rabie Elkheir",
                  },
                  {
                    text: `"TheJointApps has been instrumental in building our web presence. They put together an amazing website for us - both aesthetically pleasing and functionally sound."`,
                    author: "Sara Wander",
                  },
                  {
                    text: `"TheJointApps team was extremely professional and patient with us throughout the process of developing our mobile app. We are delighted to have partnered with them."`,
                    author: "Nour Eldin",
                  },
                ];
